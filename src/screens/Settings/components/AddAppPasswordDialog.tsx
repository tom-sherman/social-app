  ...
  const regexFailError = useMemo(
    () =>
      new DisplayableError(
        _(
          msg`App Passwords can only contain letters, numbers, spaces, dashes, and underscores`,
        ),
      ),
    [_],
  )
    ...
    mutationFn: async () => {
      ...
      if (chosenName.length < 4) {
        throw new DisplayableError(
          _(msg`App passwords must be at least 4 characters long`),
        )
      }
      if (passwords.find(p => p === chosenName)) {
        throw new DisplayableError(_(msg`Name must be unique`))
      }
            ...
            <Animated.View
              ...
              <Text
                ...
                <Trans>
                  ...
                  you lose this password, you'll need to generate a new one.
                </Trans>
              </Text>
              <Button
                label={_(msg`Done`)}
